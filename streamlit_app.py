...
st.audio("birthday.mp3",width=301)
...
for wish in wishes:
      ...
      time.sleep(2)
st.audio("https://freemusicarchive.org/music/Monk_Turner__Fascinoma/The_New_Birthday_Song_Contest/Its_Your_Birthday_1839", loop=True, autoplay=True, width=301)
st.rerun()